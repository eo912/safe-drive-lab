    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 px-8 pb-10 sm:pb-12 pointer-events-none">
        <div className="flex items-end justify-between gap-6 max-w-[1600px] mx-auto">
          <div>
            <p
              className="font-mono text-[10px] tracking-[0.45em] uppercase text-foreground/80 mb-2"
          ...
          <p
            className="text-xs sm:text-sm text-foreground/90 font-semibold tracking-wide text-right"
            style={{ textShadow: "0 2px 12px rgba(0,0,0,0.6)" }}
          >
            {pauseMinutes
